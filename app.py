...
def seed_cats():
    ...
    seed_data = [
        ...
        {'name': 'Patates', 'gender': 'Male', 'color': 'Turuncu', 'location': 'Istanbul, Sisli', 'description': 'Tombul ve mutlu bir kedi. Yemek disinda pek hareket etmez.', 'age': '5 yas'},
        {'name': 'Duman', 'gender': 'Male', 'color': 'Gri', 'location': 'Ankara, Kizilay', 'description': 'Sokaktan geldi, cok sakin. Herkesle anlasir, diger kedilerle bile.', 'age': '3 yas'},
        {'name': 'Misket', 'gender': 'Female', 'color': 'Beyaz-turuncu', 'location': 'Izmir, Bornova', 'description': 'Cok oyuncu, top gibi ziplar. Enerjisi hic bitmez.', 'age': '8 ay'},
        {'name': 'Simo', 'gender': 'Male', 'color': 'Siyah', 'location': 'Istanbul, Beyoglu', 'description': 'Gece gezen kedi, sabah uyur. Ozgurlugu cok sever.', 'age': '2 yas'},
        {'name': 'Badem', 'gender': 'Female', 'color': 'Krem', 'location': 'Bursa, Mudanya', 'description': 'Bahce bahce dolanir, herkese selam verir. Cok sosyal.', 'age': '1 yas'},
        {'name': 'Fıstık', 'gender': 'Male', 'color': 'Kahverengi-beyaz', 'location': 'Antalya, Lara', 'description': 'Plaj kedisi, guneste uyumayi cok sever. Insanlara yakinlasir.', 'age': '2 yas'},
        {'name': 'Zeytin', 'gender': 'Female', 'color': 'Siyah', 'location': 'Istanbul, Uskudar', 'description': 'Cok zeki, kapiyi acmayi ogrendi. Merakliligini gizleyemez.', 'age': '3 yas'},
        {'name': 'Pati', 'gender': 'Male', 'color': 'Gri-beyaz', 'location': 'Ankara, Gazi', 'description': 'Uzun bacakli ve hizli. Kovalamaca oynamaya bayilir.', 'age': '1.5 yas'},
        {'name': 'Ciko', 'gender': 'Male', 'color': 'Kahverengi', 'location': 'Izmir, Seferihisar', 'description': 'Balikci kedisi, deniz kenarinda yasar. Balik kokusunu alir.', 'age': '4 yas'},
        {'name': 'Bono', 'gender': 'Female', 'color': 'Siyah-beyaz', 'location': 'Istanbul, Fatih', 'description': 'Iki renkli, cok guzel. Her gozu farkli bir hikaye anlatir.', 'age': '2 yas'},
        {'name': 'Pisi', 'gender': 'Female', 'color': 'Gri', 'location': 'Konya, Selcuklu', 'description': 'Sessiz gozlerle bakar ama her seyi anlar. Cok akillica.', 'age': '1 yas'},
        {'name': 'Tomruk', 'gender': 'Male', 'color': 'Turuncu', 'location': 'Trabzon, Ortahisar', 'description': 'Dag kedisi, guclu ve bagimsiz. Ama gece gelir uyur.', 'age': '5 yas'},
        {'name': 'Mavi', 'gender': 'Male', 'color': 'Gri', 'location': 'Istanbul, Kadikoy', 'description': 'Gozleri gri, ruhu ozgur. Kimseye baglanmaz ama herkesi sevir.', 'age': '2 yas'},
        {'name': 'Karamel', 'gender': 'Female', 'color': 'Altin', 'location': 'Izmir, Cesme', 'description': 'Yaz kedisi, yazin dogmus. Guneste parlar, guler yuzlu.', 'age': '1 yas'},
        {'name': 'Yaprak', 'gender': 'Female', 'color': 'Sari-beyaz', 'location': 'Bursa, Goynuk', 'description': 'Bahce cicekleri arasinda yasar. Cicek kokusunu cok sever.', 'age': '8 ay'},
        {'name': 'Fırtına', 'gender': 'Male', 'color': 'Siyah', 'location': 'Istanbul, Kartal', 'description': 'Cok hizli kosar, hic yorulmaz. Enerji topu gibi.', 'age': '1.5 yas'},
        {'name': 'Naz', 'gender': 'Female', 'color': 'Beyaz', 'location': 'Ankara, Cankaya', 'description': 'Nazli ve sevimli. Sevince gozlerini kisar, miyav der.', 'age': '2 yas'},
        {'name': 'Tarçın', 'gender': 'Male', 'color': 'Kahverengi-cizgili', 'location': 'Istanbul, Maltepe', 'description': 'Cizgili kedi, kumsal gibi. Uyumayi ve yemegi cok sever.', 'age': '3 yas'},
        {'name': 'Suna', 'gender': 'Female', 'color': 'Turuncu', 'location': 'Antalya, Side', 'description': 'Turistik bolgede yasar, turistlere yakinlasir. Cok cana yakin.', 'age': '2 yas'},
        {'name': 'Köfte', 'gender': 'Male', 'color': 'Kahverengi', 'location': 'Bursa, Inegol', 'description': 'Inegol koftecisi kedisi. Yemek kokusuyla gelir, kofte bekler.', 'age': '4 yas'},
